...
**하나만으로는 안 된다.** 토크만 보면 가속 구간을 파지로 오독하고, 속도만 보면 도달해
멈춘 것과 막혀 멈춘 것이 같아진다. 임계 `1.0` 은 자유 이동 최대(0.845)보다 위,
파지(17.19)보다 한참 아래라 **양쪽에서 17배 이상 여유**가 있고, 빈손·파지·파지유지·
높이이탈 네 상황에서 오분류 0건이었다.
