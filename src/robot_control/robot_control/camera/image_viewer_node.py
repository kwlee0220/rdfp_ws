    ...
    def _on_image(self, msg: Image) -> None:
        ...
        if self._display_resolution is None:
            ...
            self.get_logger().info(
                f'Display resolution set from first frame: {self._display_resolution}')
        ...
        try:
            ...
            if width != target.width or height != target.height:
                frame = cv2.resize(frame, (target.width, target.height),
            ...
            self._last_display_fail_log_ts = log_periodic(
