"""`rdfp.twin.variables` 의 정적 소스 경로 단위 테스트 (설계서 4.3).
...
pytest.importorskip('rclpy', reason='rdfp.twin.variables imports rclpy')

from rdfp.twin.config import VariableConfig  # noqa: E402
from rdfp.twin.snapshot import Quality, Reason  # noqa: E402
from rdfp.twin.variables import (  # noqa: E402
