...
from camera_launch_helper import create_camera_node, declare_camera_arguments
...
def _controllers_config_path() -> str:
    ...
    return os.path.join(get_package_share_directory("rdfp"), CONTROLLERS_CONFIG_RELPATH)
