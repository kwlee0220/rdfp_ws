...
from controller_startup_launch_helper import _chain_or_shutdown, _chain_or_skip
from launch_helper import MOVEIT_CONFIGS_PACKAGE_NAME, build_servo_params
...
def _rdfp_description_path(*parts: str) -> str:
    ...
    return os.path.join(get_package_share_directory("rdfp"), "description", *parts)
